...
class SharepointTests extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->sharepoint = $this->getSharepointClient();

        $this->adapter = new SharepointAdapter($this->sharepoint, self::CONTAINER_NAME);
    }
